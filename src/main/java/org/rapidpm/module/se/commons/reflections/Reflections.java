...
import static org.rapidpm.module.se.commons.reflections.ReflectionUtils.*;
import static org.rapidpm.module.se.commons.reflections.util.Utils.*;
 ...
 * <p>in order to save a metadata use {@link #save(String)} or {@link #save(String, org.rapidpm.module.se.commons.reflections.serializers.Serializer)}
 * for example with {@link org.rapidpm.module.se.commons.reflections.serializers.XmlSerializer} or {@link org.rapidpm.module.se.commons.reflections.serializers.JavaCodeSerializer}
 * <p>in order to collect pre saved metadata and avoid re-scanning, use {@link #collect(String, com.google.common.base.Predicate, org.rapidpm.module.se.commons.reflections.serializers.Serializer...)}}
...
public class Reflections {
  public static Logger log = new Logger(Reflections.class);
   ...
   * <p>this actually create a {@link org.rapidpm.module.se.commons.reflections.Configuration} with:
   * <br> - urls that contain resources with name {@code prefix}
   * <br> - filterInputsBy where name starts with the given {@code prefix}
   * <br> - scanners set to the given {@code scanners}, otherwise defaults to {@link org.rapidpm.module.se.commons.reflections.scanners.TypeAnnotationsScanner} and {@link org.rapidpm.module.se.commons.reflections.scanners.SubTypesScanner}.
   *
   * @param prefix   package prefix, to be used with {@link org.rapidpm.module.se.commons.reflections.util.ClasspathHelper#forPackage(String, ClassLoader...)} )}
   * @param scanners optionally supply scanners, otherwise defaults to {@link org.rapidpm.module.se.commons.reflections.scanners.TypeAnnotationsScanner} and {@link org.rapidpm.module.se.commons.reflections.scanners.SubTypesScanner}
   */
   ...
   * <ul>
   * <li>{@link String} - would add urls using {@link org.rapidpm.module.se.commons.reflections.util.ClasspathHelper#forPackage(String, ClassLoader...)} ()}</li>
   * <li>{@link Class} - would add urls using {@link org.rapidpm.module.se.commons.reflections.util.ClasspathHelper#forClass(Class, ClassLoader...)} </li>
   * <li>{@link ClassLoader} - would use this classloaders in order to find urls in {@link org.rapidpm.module.se.commons.reflections.util.ClasspathHelper#forPackage(String, ClassLoader...)} and {@link org.rapidpm.module.se.commons.reflections.util.ClasspathHelper#forClass(Class, ClassLoader...)}</li>
   * <li>{@link org.rapidpm.module.se.commons.reflections.scanners.Scanner} - would use given scanner, overriding the default scanners</li>
   * <li>{@link java.net.URL} - would add the given url for scanning</li>
   * <li>{@link Object[]} - would use each element as above</li>
   * </ul>
   * <p>
   * use any parameter type in any order. this constructor uses instanceof on each param and instantiate a {@link org.rapidpm.module.se.commons.reflections.util.ConfigurationBuilder} appropriately.
  ...
  /**
   * constructs a Reflections instance and scan according to given {@link org.rapidpm.module.se.commons.reflections.Configuration}
   ...
   * and de-serializes them using the default serializer {@link org.rapidpm.module.se.commons.reflections.serializers.XmlSerializer} or using the optionally supplied optionalSerializer
   * <p>
   ...
   *
   * @param optionalSerializer - optionally supply one serializer instance. if not specified or null, {@link org.rapidpm.module.se.commons.reflections.serializers.XmlSerializer} will be used
   */
  ...
  /**
   * returns the {@link org.rapidpm.module.se.commons.reflections.Store} used for storing and querying the metadata
   */
  ...
  /**
   * returns the {@link org.rapidpm.module.se.commons.reflections.Configuration} object of this instance
   */
   ...
   * <p>see the documentation for the save method on the configured {@link org.rapidpm.module.se.commons.reflections.serializers.Serializer}
   */
