 ...
 * <p>use the {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs#fromURL(java.net.URL)} to get a {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs.Dir}
 * and than use {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs.Dir#getFiles()} to iterate over it's {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs.File}
 * <p>for example:
 * <pre>
 ...
 *      }
 * </pre>
 * <p>use {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs#findFiles(java.util.Collection, com.google.common.base.Predicate)} to get an
 * iteration of files matching given name predicate over given list of urls
 * <p><p>{@link org.rapidpm.module.se.commons.reflections.vfs.Vfs#fromURL(java.net.URL)} uses static {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs.DefaultUrlTypes} to resolves URLs
 * and it can be plugged in with {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs#addDefaultURLTypes(org.rapidpm.module.se.commons.reflections.vfs.Vfs.UrlType)} or {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs#setDefaultURLTypes(java.util.List)}.
 * <p>for example:
 * <pre>
...
public abstract class Vfs {
  ...
  /**
   * the default url types that will be used when issuing {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs#fromURL(java.net.URL)}
   */
  ...
  /**
   * return an iterable of all {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs.File} in given urls, starting with given packagePrefix and matching nameFilter
   */
  ...
  /**
   * return an iterable of all {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs.File} in given urls, matching filePredicate
   */
  ...
  /**
   * default url types used by {@link org.rapidpm.module.se.commons.reflections.vfs.Vfs#fromURL(java.net.URL)}
   * <p>
   * <p>jarFile - creates a {@link org.rapidpm.module.se.commons.reflections.vfs.ZipDir} over jar file
   * <p>jarUrl - creates a {@link org.rapidpm.module.se.commons.reflections.vfs.ZipDir} over a jar url (contains ".jar!/" in it's name)
   * <p>directory - creates a {@link org.rapidpm.module.se.commons.reflections.vfs.SystemDir} over a file system directory
   */
