  ...
  private void addProxiedMethod(PrintWriter out, Method m) {
    ...
    if (returnType == void.class) out.printf(");%n }%n");
      ...
      if (!returnType.isPrimitive() && !returnType.isArray() && !aFinal) {
        ...
        final String proxyGenerator = "org.rapidpm.module.se.commons.proxy.type.virtual.ProxyGenerator";
        final String concurrency = "org.rapidpm.module.se.commons.proxy.type.virtual.Concurrency";
