...
import org.rapidpm.module.se.commons.reflections.ReflectionUtils;
...
import org.rapidpm.module.se.commons.reflections.scanners.TypeElementsScanner;
...
import static org.rapidpm.module.se.commons.reflections.Reflections.log;
import static org.rapidpm.module.se.commons.reflections.util.Utils.prepareFile;
import static org.rapidpm.module.se.commons.reflections.util.Utils.repeat;
 ...
 * <pre>
 *  Class&#60? extends IMethod> imethod = MyTestModelStore.org.rapidpm.module.se.commons.reflections.TestModel$C4.m1.class;
 *  Method method = JavaCodeSerializer.resolve(imethod);
 * </pre>
 * <p>depends on Reflections configured with {@link org.rapidpm.module.se.commons.reflections.scanners.TypeElementsScanner}
 * <p><p>the {@link #save(org.rapidpm.module.se.commons.reflections.Reflections, String)} method filename should be in the pattern: path/path/path/package.package.classname
 */
