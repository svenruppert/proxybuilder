...
import org.rapidpm.proxybuilder.proxy.generated.annotations.IsLoggingProxy;
...
public class StaticLoggingProxyAnnotationProcessor
  ...
  protected FieldSpec defineLoggerField(final TypeElement typeElement) {
    ...
    return FieldSpec.builder(loggerClassName, LOGGER)
  ...
  protected CodeBlock defineMethodImplementation(final ExecutableElement methodElement,
    ...
    codeBlockBuilder.beginControlFlow("if (" + LOGGER + ".isInfoEnabled())")
                    .addStatement(LOGGER
                                  + ".info(\""
                                  + DELEGATOR_FIELD_NAME
                                  + "."
                                  ...
                                  + ((methodElementParameters.isEmpty())
                                     ? "\")"
                                     : " values - \" + " + joinString(methodElementParameters) + ")"))
                    .endControlFlow();
